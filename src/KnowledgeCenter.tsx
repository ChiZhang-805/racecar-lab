      ...
      <div className="knowledge-modal" ref={dialogRef} tabIndex={-1}>
        ...
        <main className="knowledge-main">
          {!finished ? <>
            ...
            {notice && <BalancedParagraph className="knowledge-notice" locale={locale} text={notice} />}
            {submitted && <section className={`knowledge-explanation ${selected === question.answer ? 'is-correct' : 'is-wrong'}`}><div><strong>{selected === question.answer ? u.correct : u.incorrect}</strong></div><BalancedParagraph locale={locale} text={localise(question.explanation, locale)} /></section>}
