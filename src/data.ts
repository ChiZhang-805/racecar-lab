...
export const PARTS: PartInfo[] = [
  ...
  },
  {
    ...
    short: '由前防滚架、主防滚架、斜撑、头枕和安全带共同形成的 Formula Student 座舱防护系统。',
    purpose: '在翻滚或碰撞中维持驾驶员头盔周围的生存空间，并把驾驶员可靠约束在受保护包络内。',
    analogy: '像围绕驾驶员搭建的承力安全笼，头枕和安全带负责把人留在它保护的空间内。',
    observe: ['从侧面检查头盔是否位于前、主防滚架形成的保护包络内。', '追踪主防滚架斜撑和安装点如何把载荷传入车架。', '检查座椅、头枕、安全带路径以及驾驶员逃生空间。'],
    engineering: ['防滚架强度、支撑几何和连续载荷路径必须共同满足安全要求。', '座椅、头枕、安全带和驾驶姿态共同决定事故中的头部与躯干约束。', '保护包络还要兼顾正常视野、操纵空间和快速逃生。'],
    faults: ['焊趾、斜撑或安装点损伤会削弱翻滚载荷路径。', '头盔超出保护包络或约束位置错误会增加头颈伤害风险。'],
    connections: ['车架与单体壳', '座椅、头枕与安全带'], camera: [4.4, 3.3, 1.0], target: [0, 1.48, 0.25],
  },
  {
    id: 'tires', name: '光头赛车轮胎', nameEn: 'RACING SLICKS', category: 'dynamics', index: '07',
    short: '赛车加速、制动和转弯时与路面交换的纵向力和横向力，都通过四块很小的接地面积传递。',
  ...
  },
  {
    ...
    analogy: '制动器不会让能量消失，而是把车辆动能转化为制动盘上的热。',
    observe: ['隐藏轮胎，查看制动盘和卡钳。', '切换制动场景，观察盘温颜色变化。', '比较制动时前后轴箭头长度。'],
    engineering: ['制动平衡需要随载荷转移和下压力变化设定。', '单轮制动力矩近似满足 T_b ≈ μ F_clamp R_eff，即由摩擦系数、卡钳夹紧力和有效摩擦半径共同决定。', '散热不足会引起衰退，温度过低也可能达不到最佳摩擦。'],
...
export const COURSES: Course[] = [
  { id: 'orientation', number: '00', title: '认识赛车', subtitle: '建立整车地图', description: '先不急着背术语。找到一辆方程式赛车最重要的系统，理解它们为什么围绕轮胎协同工作。', parts: ['front-wing', 'monocoque', 'tires'], task: '依次找到前翼、单体壳和轮胎，并分别隔离观察。', question: '赛车加速、制动和转弯时，与路面交换的纵向力和横向力通过什么传递？', options: ['车架', '空气', '轮胎', '电池'], answer: 2 },
  ...
  { id: 'tires', number: '02', title: '轮胎与抓地', subtitle: '路面作用力的最终出口', description: '学习纵向力、横向力、滑移、温度和载荷敏感性，建立“抓地预算”的概念。', parts: ['tires', 'brakes'], task: '进入转弯场景，找出载荷最大的外侧轮胎。', question: '要求轮胎同时极限制动和极限转弯时会怎样？', options: ['抓地自动翻倍', '两种需求争夺有限抓地', '只影响胎温', '完全没有影响'], answer: 1 },
  { id: 'braking', number: '03', title: '制动系统', subtitle: '把动能转化为热', description: '观察制动盘温升、前后轴载荷变化，以及制动平衡如何影响稳定性。', parts: ['brakes', 'tires', 'front-suspension'], task: '打开制动场景并隐藏轮胎，观察制动盘的温度变化。', question: '制动盘的主要能量转换是什么？', options: ['热能变动能', '动能变热能', '电能变势能', '气压变电能'], answer: 1 },
