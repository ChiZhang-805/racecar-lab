...
export const copy = {
  zh: {
    ...
    courseMap: '课程地图', knowledge: '知识问答', resetView: '复位视角', resetCar: '复原赛车', pauseCar: '暂停旋转', resumeCar: '继续旋转', home: '返回首页', settings: '设置',
  ...
  en: {
    ...
    courseMap: 'Course map', knowledge: 'Knowledge centre', resetView: 'Reset view', resetCar: 'Reset car', pauseCar: 'Pause rotation', resumeCar: 'Resume rotation', home: 'Home', settings: 'Settings',
