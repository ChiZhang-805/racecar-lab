...
- 腾讯云 release `20260716T140047Z_c8a8891` 已原子部署，Nginx 为 active；上一健康版本 `20260716T130635Z_04b47bf` 保留为回滚点，公网加载新生产资源 `index-C0SMuN1y.js` 与 `index-DDcrh3LB.css`。
...
- 当前 release 公网车型研究矩阵通过：中英文 Mercedes 头图均完整显示前后轮、前翼与尾翼，轮胎底部至少保留 12 px，四张事实卡保持压缩后的高度上限，三档文字达到字号下限；1440×900 与 390×844 页面无横向溢出，浏览器错误为 0。
