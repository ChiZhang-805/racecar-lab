...
- 新增 Ferrari、McLaren、Mercedes、Red Bull 四张车手卡；桌面四卡同排，每卡上下两位车手，平板两列，手机单列。
...
- 新增测试断言：车队各两人、8 个 ID 唯一、双语隔离、图片路径/体积/来源/许可、三页签等宽、说明文字已移除、赛车 SVG 结构数量、字号下限、桌面/320 px 无横向溢出、照片实际解码与车手左右区域不重叠。
...
| `src/styles.css` | 桌面、320–390 px 手机竖屏、英文长词、无页面级滚动、弹窗内部滚动 | 车库三栏全宽、对比正文显著放大、车手区四列/两列/单列响应式切换；窄屏内部滚动且无横向溢出；通过 |
