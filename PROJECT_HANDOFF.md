...
- 当前线上应用提交：`54c3476`（`feat: upgrade 2026 team liveries`）
- 当前线上 release：`20260716T114839Z_54c3476`
- 上一回滚 release：`20260716T104108Z_9794e7d`
- 最终验证：Vitest `74/74`、Playwright `13/13`、TypeScript 与 Vite 生产构建通过
- 公网冒烟：英文 1440×900 与中文 390×844 各切换 Ferrari、McLaren、Mercedes、Red Bull；8/8 返回 `200`，每车均暴露 10 区漆面签名，页面宽度分别严格保持 `1440` 与 `390`，浏览器错误 `0`
- 本轮完整备份：`C:\Users\zju20\Documents\Codex\2026-07-16\yue\outputs\racecar-lab-livery-upgrade-2026-07-16`

本文件之后如果仅有交接/备份类文档提交，线上应用仍对应 `54c3476`；不要把纯文档提交误报为已重新部署的页面版本。
